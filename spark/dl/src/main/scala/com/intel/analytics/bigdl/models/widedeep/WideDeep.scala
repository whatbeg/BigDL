...
object WideDeep {
  def apply[T: ClassTag](modelType: String, classNum: Int = 2)
    ...
    deepColumn.add(Sequential().add(Select(2, 1023214)).add(LookupTable(100, 8, 0.0)))   // workclass 100
    deepColumn.add(Sequential().add(Select(2, 1023215)).add(LookupTable(1000, 8, 0.0)))  // education 1000
    deepColumn.add(Sequential().add(Select(2, 1023216)).add(LookupTable(2, 8, 0.0)))   // gender 2
    deepColumn.add(Sequential().add(Select(2, 1023217)).add(LookupTable(100, 8, 0.0)))   // relationship 100
    deepColumn.add(Sequential().add(Select(2, 1023218)).add(LookupTable(1000, 8, 0.0)))  // native_country 1000
    deepColumn.add(Sequential().add(Select(2, 1023219)).add(LookupTable(1000, 8, 0.0)))  // occupation 1000
