...
class WideDeepSpec extends FlatSpec with BeforeAndAfter with Matchers {
  "wide deep" should "forward" in {
    ...
    for (i <- 1 to 4) {
      wideColumn.setValue(i, 1, Random.nextFloat())
      wideColumn.setValue(i, 2, Random.nextFloat())
      wideColumn.setValue(i, 3, Random.nextFloat())
      wideColumn.setValue(i, 4, Random.nextFloat())
      wideColumn.setValue(i, 5, Random.nextFloat())
      ...
      wideColumn.setValue(i, 2006, Random.nextFloat())
